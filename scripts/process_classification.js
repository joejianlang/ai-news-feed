...
分类规则（按优先级排序）：
1. **本地**：如果内容涉及加拿大（特别是多伦多、滑铁卢、温哥华、渥太华等加拿大城市），强制归类为"本地"
2. **热点**：如果内容提到"引发热议"、"突发"、"争议"、"爆料"、"疯传"等词汇，标记为"热点"
3. **深度**：如果正文字数超过1200字，或涉及宏观趋势分析、深度调查报道，归类为"深度"
4. **其他分类**：
   - 财经：金融、股市、经济、投资、商业相关
   - 科技：AI、科技产品、互联网、软件、硬件相关
   - 政治：政府、选举、政策、国际关系相关
   - 文化娱乐：电影、音乐、明星、文化活动相关
   - 体育：体育赛事、运动员、体育新闻相关
