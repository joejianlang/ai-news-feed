...
分类规则（按优先级排序）：
1. **本地**：如果新闻**事件发生地点**在加拿大（特别是多伦多、滑铁卢、温哥华、渥太华等），归类为"本地"。注意：判断标准是事件发生地，而不是报道媒体的来源。例如，加拿大媒体报道美国大选不算本地，但发生在多伦多的事件算本地。
2. **热点**：如果内容提到"引发热议"、"突发"、"争议"、"爆料"等词汇，或涉及重大突发事件，标记为"热点"
3. **深度**：如果正文字数超过1200字，或涉及宏观趋势分析、专题分析，归类为"深度"
