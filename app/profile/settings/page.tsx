        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 pb-20">
            ...
            <div className="max-w-[600px] mx-auto p-4 space-y-6">
                ...
                <section className="space-y-3">
                    <h2 className="px-2 text-[11px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-widest">Profile Identity</h2>
                    <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-800">
                        <button className="w-full flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                            <div className="flex items-center gap-4 text-left">
                                ...
                                <div>
                                    <div className="font-black text-[16px]">Avatar</div>
                                    <div className="text-[12px] text-slate-400 font-bold">Tap to upload a new one</div>
                                </div>
                            </div>
                        ...
                        <button onClick={() => setActiveModal('nickname')} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                            <div className="flex flex-col text-left">
                                <span className="text-[11px] font-black text-slate-400 uppercase tracking-tight mb-0.5">Display Name</span>
                                <span className="font-black text-[15px]">{user.display_name || 'Anonymous User'}</span>
                            </div>
                            <ChevronRight className="w-5 h-5 text-slate-200 group-hover:text-indigo-500 transition-colors" />
                        </button>
                    </div>
                ...
                {/* Security Section */}
                <section className="space-y-3">
                    <h2 className="px-2 text-[11px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-widest">Security & Privacy</h2>
                    <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-800">
                        <button onClick={() => setActiveModal('email')} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                            <div className="flex items-center gap-4 text-left">
                                ...
                                <div>
                                    <div className="font-black text-[15px]">Account Email</div>
                                    <div className="text-[12px] text-slate-400 font-bold">{user.email}</div>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="text-[10px] bg-green-500/10 text-green-500 px-2.5 py-1 rounded-full font-black uppercase tracking-tighter">Verified</span>
                                <ChevronRight className="w-5 h-5 text-slate-200 group-hover:text-indigo-500 transition-colors" />
                            </div>
                        </button>
                        <div className="h-px bg-slate-100 dark:bg-slate-800/50 mx-4"></div>
                        <button onClick={() => setActiveModal('phone')} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                            <div className="flex items-center gap-4 text-left">
                                ...
                                <div>
                                    <div className="font-black text-[15px]">Phone Number</div>
                                    <div className="text-[12px] text-slate-400 font-bold">{user.phone || 'Not linked'}</div>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                {!user.phone && <span className="text-[10px] bg-orange-500/10 text-orange-500 px-2.5 py-1 rounded-full font-black uppercase tracking-tighter">Unlinked</span>}
                                <ChevronRight className="w-5 h-5 text-slate-200 group-hover:text-indigo-500 transition-colors" />
                            </div>
                        </button>
                        <div className="h-px bg-slate-100 dark:bg-slate-800/50 mx-4"></div>
                        <button onClick={() => setActiveModal('password')} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="font-black text-[15px]">Update Password</div>
                            </div>
                            <ChevronRight className="w-5 h-5 text-slate-200 group-hover:text-indigo-500 transition-colors" />
                        </button>
                    </div>
                ...
                {/* Ads Section */}
                <section className="space-y-3">
                    <h2 className="px-2 text-[11px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-widest">Ads Management</h2>
                    <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-800">
                        <button onClick={() => router.push('/profile/ads')} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="font-black text-[15px]">My Active Ads</div>
                            </div>
                            <ChevronRight className="w-5 h-5 text-slate-200 group-hover:text-indigo-500 transition-colors" />
                        </button>
                        <div className="h-px bg-slate-100 dark:bg-slate-800/50 mx-4"></div>
                        <button onClick={() => router.push('/ads/create')} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="font-black text-[15px]">Launch Campaign</div>
                            </div>
                            <ChevronRight className="w-5 h-5 text-slate-200 group-hover:text-indigo-500 transition-colors" />
                        </button>
                    </div>
                ...
                {/* Preferences Section */}
                <section className="space-y-3">
                    <h2 className="px-2 text-[11px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-widest">Preferences</h2>
                    <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-800">
                        <div className="flex items-center justify-between p-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="font-black text-[15px]">Push Notifications</div>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="font-black text-[15px]">Dark Mode</div>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-800">
                        <button onClick={() => setActiveModal('delete')} className="w-full flex items-center justify-between p-4 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors group">
                            <div className="flex items-center gap-4 text-red-600 text-left">
                                ...
                                <div>
                                    <div className="font-black text-[15px]">Delete Account</div>
                                    <div className="text-[11px] text-red-400 font-bold uppercase tracking-tight">Irreversible action</div>
                                </div>
                            </div>
                ...
                <button
                    ...
                    className="w-full py-4.5 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 font-black rounded-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all active:scale-[0.98]"
                >
                    <LogOut className="w-5 h-5" />
                    Logout Account
                </button>

                <p className="text-center text-slate-300 dark:text-slate-700 text-[10px] font-black pt-4 pb-8 uppercase tracking-[0.2em] animate-pulse">Digital Buffet Engine v1.2</p>
            </div>
